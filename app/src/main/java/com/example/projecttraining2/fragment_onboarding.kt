...
import com.example.projecttraining2.databinding.FragmentOnboardingBinding
...
//        return inflater.inflate(R.layout.fragment_onboarding, container, false)
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance(title: String, description: String, imageResource: Int): fragment_onboarding {
            var fragment = fragment_onboarding()
            var args = Bundle()
